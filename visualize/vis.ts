import { randomNodes, AStar, Raycast, randomWalls, Node, Line, Entry, Point, RayE, HookData } from "../src/astar";
...
async function doOP() {
    ...
    const _nodes2 = _nodes.map((r) => { return { ...r, edges: new Set<number>() } })
